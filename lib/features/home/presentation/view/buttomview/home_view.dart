              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) => BlocProvider(
                    create: (context) => SearchCubit(homeState.cars),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('\$${car.regularPrice.toStringAsFixed(2)}', style: const TextStyle(fontSize: 16, color: Colors.green, fontWeight: FontWeight.w600)),
