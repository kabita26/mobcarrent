import 'package:carrent/features/auth/presentation/view/login_view.dart'; 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFFE0E1DD), // Primary color for AppBar
      ),
      body: Column(
        children: [
          Expanded(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                        ...
                        color: Color(0xFF415A77), // Dark text color
                      ),
                    ),
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF778DA9), // Button background color
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: currentPage == index
            ? const Color(0xFF778DA9) // Active dot color
